...
class GoogleMapView(context: Context, mapOptions: MapOptions?): MapView {

    private val view = com.google.android.gms.maps.MapView(context, (mapOptions as? GoogleMapOptionsWrapper)?.mDelegate)
    ...
    override fun getMapAsync(callback: MapKit.OnMapReadyCallback) {
        view.getMapAsync {
            callback.onMapReady(GoogleMapClient(it))
        }
    }
}