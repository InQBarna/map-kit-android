...
public interface Map {
    ...
    interface Factory {
        ...
        @NonNull
        CameraPosition.Builder newCameraPositionBuilder(@NonNull CameraPosition camera);

        @NonNull
        Circle.Options newCircleOptions();

        @NonNull
        CustomCap newCustomCap(@NonNull BitmapDescriptor bitmapDescriptor, float refWidth);
        ...
        @NonNull
        Dash newDash(float length);

        @NonNull
        Gap newGap(float length);
        ...
        @NonNull
        LatLngBounds newLatLngBounds(@NonNull LatLng southwest, @NonNull LatLng northeast);
        ...
        @NonNull
        TileProvider newUrlTileProvider(
